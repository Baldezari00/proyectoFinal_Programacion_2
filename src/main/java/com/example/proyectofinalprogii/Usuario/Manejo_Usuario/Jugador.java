...
public class Jugador {
    // TRABAJO FEDE:
    // manejar la lógica del registro de jugadores, junto con algunos atributos básicos como "oro(int)",
    // "opcionesElegidas(int)" -> inicializado en 0, y después el nombre y contraseña.
